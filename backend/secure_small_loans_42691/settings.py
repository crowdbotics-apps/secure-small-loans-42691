"""
Django settings for secure_small_loans_42691 project.
...
ROOT_URLCONF = 'secure_small_loans_42691.urls'
...
WSGI_APPLICATION = 'secure_small_loans_42691.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "secure_small_loans_42691 API",
    "DESCRIPTION": "API documentation for secure_small_loans_42691 App",
    "VERSION": "v1",
}
